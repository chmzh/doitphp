                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="/tea/edit" method="post">
                                    <input type="hidden" name="id" value="<?php echo $tea['id']?>">
                                        ...
                                        <?php foreach ($categorys as $k=>$v){?>
										  <option value="<?php echo $v['id']?>"<?php if($v['id']==$tea['categoryid']){?> selected="selected" <?php }?>><?php echo $v['name']?></option>
									    <?php }?>
									</select>
                                       
                                        <div class="form-group">
                                            <label>名称</label>
                                            <input class="form-control" placeholder="名称" id="name" name="name" value="<?php echo $tea['name']?>">
                                            <span id="gamename_clew"></span>
                                        </div>
                                        <div class="form-group">
                                            <label>价钱</label>
                                            <input class="form-control" id="price" name="price" value="<?php echo $tea['price']?>">
                                            <span id="gamename_clew"></span>
                                        </div>
                                       <input type="text" name="imgsrc" id="imgsrc" value="<?php echo $tea['imgsrc']?>"><span onclick="reupload()" style="cursor:pointer">重新上传</span>
									<div class="form-group" id="uploadframe">
										<iframe src="/upload/index" frameborder="0" height="35px" scrolling="no" width="100%"></iframe>
									</div>
									<div class="form-group">
                                            <label>描述</label>
                                            <input class="form-control" id="des" name="des" placeholder="描述" value="<?php echo $tea['des']?>">
                                            <span id="gamename_clew"></span>
                                        </div>
                                        <div class="form-group">
