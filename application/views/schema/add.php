                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="/schema/add" method="post">
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                            <label>描述</label>
                                            <input class="form-control" name="des" placeholder="描述">
                                            <p class="help-block"></p>
                                     </div>
                                    <label>选择游戏</label>
									...
									<?php foreach ($parentMenus as $pk=>$pv){?>
										  ...
										  <input type="checkbox" name="power[]" value="<?php echo $sv['id'];?>" /><?php echo $sv['name'];?>
										</label>
										<?php }}?> 
											<br>
									<?php }?>                                                                        
