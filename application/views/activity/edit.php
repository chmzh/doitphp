                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="/activity/edit" method="post">
                                    <input type="hidden" name="id" value=<?php echo $activity['id']?>>
                                        <div class="form-group">
                                            <label>标题</label>
                                            <input class="form-control" name="title" placeholder="标题" value="<?php echo $activity['title']?>">
                                            <p class="help-block"></p>
                                        </div>
                                        开始日期:<input size="16" type="text" value="<?php echo $activity['sdate']?>" name="sdate" readonly class="form_datetime">
                                        结束日期:<input size="16" type="text" value="<?php echo $activity['edate']?>" name="edate" readonly class="form_datetime1">
                                       <div class="form-group">
                                            <label>地址</label>
                                            <input class="form-control" name="address" placeholder="地址" value="<?php echo $activity['address']?>">
                                            <p class="help-block"></p>
                                        </div>
                                        <div class="form-group">
                                            <label>参与人</label>
                                            <input class="form-control" name="participants" placeholder="参与人" value="<?php echo $activity['participants']?>">
                                            <p class="help-block"></p>
                                        </div>
									<input type="text" name="imgsrc" id="imgsrc" value="<?php echo $activity['imgsrc']?>"><span onclick="reupload()" style="cursor:pointer">重新上传</span>
